...
RSpec.describe ParkingSpotsController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested parking_spot as @parking_spot" do
      parking_spot = ParkingSpot.create! valid_attributes
      get :show, params: {id: parking_spot.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested parking_spot as @parking_spot" do
      parking_spot = ParkingSpot.create! valid_attributes
      get :edit, params: {id: parking_spot.to_param}, session: valid_session
      expect(assigns(:parking_spot)).to eq(parking_spot)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new ParkingSpot" do
        expect {
          post :create, params: {parking_spot: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved parking_spot as @parking_spot" do
        post :create, params: {parking_spot: invalid_attributes}, session: valid_session
        expect(assigns(:parking_spot)).to be_a_new(ParkingSpot)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested parking_spot" do
        parking_spot = ParkingSpot.create! valid_attributes
        put :update, params: {id: parking_spot.to_param, parking_spot: new_attributes}, session: valid_session
        parking_spot.reload
      ...
      it "assigns the requested parking_spot as @parking_spot" do
        parking_spot = ParkingSpot.create! valid_attributes
        put :update, params: {id: parking_spot.to_param, parking_spot: valid_attributes}, session: valid_session
        expect(assigns(:parking_spot)).to eq(parking_spot)
      end
    ...
    context "with invalid params" do
      it "assigns the parking_spot as @parking_spot" do
        parking_spot = ParkingSpot.create! valid_attributes
        put :update, params: {id: parking_spot.to_param, parking_spot: invalid_attributes}, session: valid_session
        expect(assigns(:parking_spot)).to eq(parking_spot)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested parking_spot" do
      parking_spot = ParkingSpot.create! valid_attributes
      expect {
        delete :destroy, params: {id: parking_spot.to_param}, session: valid_session
      }.to change(ParkingSpot, :count).by(-1)
    end
